...
class Withdraw extends Component {
  ...
  render() {
    ...
    console.log(`account.address: ${web3.toChecksumAddress(this.props.account.address)}`)
    console.log(`campaign.manager: ${web3.toChecksumAddress(this.props.campaign.manager)}`)
