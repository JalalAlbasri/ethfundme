...
contract('Campaign Approval', (accounts) => {
  ...
  before('set up contract instances', (done) => {
    EthFundMe.deployed()
      ...
      .then((campaignAddress) => {
        ...
        return CampaignInstance.numAdmins.call()
      })
      .then((numAdmins) => {
        console.log(`numAdmins: ${numAdmins}`)
        done()
  ...
  //   CampaignInstance.vote(originalVoteSecret0, { from: accounts[4] })
  //     .catch((e) => {
  ...
  //   CampaignInstance.reveal(newVoteOption0, 0, { from: accounts[0] })
  //     .catch((e) => {
  //       return CampaignInstance.numVoteReveals.call()
  //     })
  //     .then((numVoteReveals) => {
  ...
  //   CampaignInstance.reveal(true, salt, { from: accounts[0] })
  //     .catch((e) => {
  //       return CampaignInstance.numVoteReveals.call()
  //     })
  //     .then((numVoteReveals) => {
  ...
  //   CampaignInstance.reveal(newVoteOption0, salt, { from: accounts[4] })
  //     .catch((e) => {
  //       return CampaignInstance.numVoteReveals.call()
  //     })
  //     .then((numVoteReveals) => {
